...
# 
# We do see that the final model has a higher average Reward per run, which implies that the final model used is taking a higher scoring path to it's destination each run.
# 
